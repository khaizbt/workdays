            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="password" name="password" placeholder="New password (Only if you want to change the password)" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Confirm Password</label>
                        <div class="col-sm-12 col-md-7">
                            <input type="password" name="password_confirmation" placeholder="New password Confirmation (Only if you want to change the password)" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
